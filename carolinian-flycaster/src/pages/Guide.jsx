      ...
      <main id="main-content">
        <div className="page-paragraph-content">
          <section className="f-container">
            <ListItems 
              title="Necessary Steps to Get Started"
              paragraph1="Step 1: What gear?"
              paragraph2="Step 2: Where to go?"
              paragraph3="Step 3: What to catch?"
              paragraph4="Step 4: How to cast"
              paragraph5="Step 5: How to attract and catch"
              paragraph6="Step 6: How to handle fish"
              paragraph7="Step 7: Have fun!"
            />
