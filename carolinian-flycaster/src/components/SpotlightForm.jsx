        ...
        <div id="spotlight-form-container" className="f-container">
          <section>
            <ul>
              <li>
                Name of Location:{" "}
                <input id="locationname" type="text" name="name" minLength="3" required />
              </li>
              <li>
                Summary of Location:{" "}
                <input id="summary" type="text" name="summary"  minLength="3" required />
              </li>
              <li>
              ...
              <li>
                ...
                <input id="fishcaught" type="text" name="fishes" minLength="3" required />
              </li>
              <li>
                Types of Flies Used:{" "}
                <input id="fliesused" type="text" name="flies" minLength="3" required />
              </li>
              <li>
                What Body of Water:{" "}
                <input
          ...
          <section>
            <ul>
              ...
              <li>
                Best Season to Fish:{" "}
                <input id="bestmonths" type="text" name="seasons" minLength="3" required />
              </li>
              <li></li>
            </ul>
          </section>
